...
The coastline does not, at v0.3, commit to one of these as canonical. It commits only to the position that *consensus-emergence is operational, not metaphorical*, and that any deployment of the framework must specify which measure is being used.
...
5. A bridge to the Causal Clock Unification Framework (CCUF) or to any other Harbour framework. Such bridges may exist (see *Deferred Items*) but are not committed at v0.3.
...
The following are noted as plausible future extensions but are **not committed** at v0.3:
