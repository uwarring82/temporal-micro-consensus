...
- **CL-2026-007 — opened 2026-05-26** ([`ledger/CL-2026-007-smith-ahmadi-v0.1.md`](../ledger/CL-2026-007-smith-ahmadi-v0.1.md)). Smith & Ahmadi, *Quantum clocks observe classical and quantum time dilation*, *Nat. Commun.* 11, 5360 (2020). Classified **UNDERDETERMINED** against Coastline v0.3 under declared measure F[τ] (Fisher information — distinct from CL-2026-006's mutual-information choice). Crux: whether the quantum time-dilation correction is coherence-dependent (superposition ≠ classical mixture); the coherence-sensitive discriminant it lacks is exactly what the Sorci visibility witness (CL-2026-006) supplies.
