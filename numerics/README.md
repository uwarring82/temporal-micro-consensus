...
- **Q5 (open — Phase 0 TODO):** reconcile with CL-2026-005 (the "CBG" open-quantum-systems pipeline), which CL-2026-006 names as the D1-decomposition infrastructure — decide reuse vs. independent QuTiP reimplementation before building Module 3a.
